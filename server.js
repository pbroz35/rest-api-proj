...
import moviesRouter from './routes/popular.js' //imported from ./src/fetch_popular.js, router created using Express to handle routes realted to fetching popular movies
